...
public class UserController {
	...
	public ResponseEntity<ResponseModel> register(@RequestBody RegisterUserdto registerUserdto){
		log.info("Inside controller"+registerUserdto.toString());
		return authenticationService.saveUser(registerUserdto);
	}
	
	@PostMapping("/login")
	public ResponseEntity<ResponseModel> login(@RequestBody LoginUserdto loginUserdto){
